...
const Write = () => {
    ...
    return (
        <WriteDiv>
            <UserDiv>
                <FaRegUserCircle/><span>{user && user.username}님</span>
                <div className='WrteDiv'>
                    <button onClick={()=>navigate("/Community")}>취소</button>   
                    <button onClick={handleWriteClick}>글쓰기</button>
                </div>
            </UserDiv>
            <TitleInput name='title' placeholder='제목을 입력하세요' value={title} onChange={(e)=>setTitle(e.target.value)}/>
            <QuillDiv>
